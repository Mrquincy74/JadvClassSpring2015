...
function checkForm(e)
{
    ...
    var jsondata = {}; // declared var data 
    ...
    for (var i = 0, l = paragraphs.length; i < l; i++)
    {
        ...
        jsondata[input.name] = input.value; // data input.name is the name of the fields Address = input.value 
    ...
    if (dataString) {
        ...
        {
            output += k + " : " + DataJson[k] + '<br />';
            
        }
        var c = document.querySelector('[name="delete"]');
        document.querySelector('#confirmation').innerHTML = output;
...
window.addEventListener('load', Databla);
...
function Databla() {
    ...
    function remove(r) {
        ...
        r.preventDefault();
        localStorage.removeItem('test this');
        console.log("this is not woring ;(");
    }
